    ...
    return (
        <section id="contatti" className="section bg-[var(--color-bg-secondary)]">
            <div className="container-custom">
                <SectionHeading
                    title="Contattami"
                    subtitle="Compila il form o contattami direttamente"
                />

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    {/* Contact Form */}
                    <div className="bg-white rounded-xl p-6 md:p-8 shadow-sm order-2 lg:order-1">
                        <h3 className="text-xl font-medium mb-6">Richiedi un appuntamento</h3>
                        <ContactForm />
                    </div>
                        ...
                        <div className="bg-white rounded-xl p-6 md:p-8 shadow-sm">
                            ...
                            <ul className="space-y-5">
                                ...
                                <li className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p className="font-medium text-[var(--color-text-primary)]">Indirizzo</p>
                                ...
                                <li className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p className="font-medium text-[var(--color-text-primary)]">Telefono</p>
                                        <a
                            ...
                            {/* Social Links */}
                            <div className="mt-6 pt-6 border-t border-gray-100">
                                <p className="text-sm text-[var(--color-text-muted)] mb-3">Seguimi sui social</p>
