        ...
        <section id="contatti" className="section bg-[var(--color-bg-secondary)]">
            <div className="container-custom">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    {/* Contact Form */}
                    <div className="bg-[var(--color-bg-primary)] border border-[var(--color-bg-accent)] rounded-3xl p-6 md:p-8 shadow-sm order-2 lg:order-1">
                    ...
                    <div className="space-y-6 order-1 lg:order-2">
                        ...
                        <div className="bg-[var(--color-bg-primary)] border border-[var(--color-bg-accent)] rounded-3xl p-6 md:p-8 shadow-sm">
                            ...
                            {/* WhatsApp Button */}
                            <div className="mt-6 pt-6 border-t border-[var(--color-bg-accent)]">
                                <a
                                    href={whatsappUrl}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center justify-center gap-2 w-full py-3 px-4 bg-[#25D366] hover:bg-[#20BA5C] text-white font-medium rounded-2xl transition-colors shadow-sm hover:shadow-md hover:-translate-y-0.5"
                                >
